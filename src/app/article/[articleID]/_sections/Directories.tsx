	...
	return (
		<>
			<section className='section pt-24 pb-12 flex flex-wrap gap-8 px-8 !h-auto !min-h-screen mobile:hidden'>
				...
				{Array.from({ length: 10 }, () => ({ ...article })).map(
					(art, index) => (
						<div
						...
						>
							<img
								...
								alt={art.title}
							/>
							<div className='w-full h-1/5 bg-red-800 z-[100] relative bg-[rgba(0,0,0,0.50)] backdrop-blur-[1rem] rounded-[0px_0px_3rem_3rem] flex items-center pl-8'>
			...
			<section className='section pt-24 !hidden flex-wrap gap-8 px-8 mobile:px-[16px] !h-auto !min-h-screen mobile:flex'>
				...
				<div className='grid grid-cols-2 gap-[16px] w-full pb-4'>
					{Array.from({ length: 13 }, () => ({ ...article })).map(
						(art, index) => (
							<div
							...
							>
								<img
									...
									alt={art.title}
								/>
								<div className='w-full h-1/4 bg-red-800 z-[100] relative bg-[rgba(0,0,0,0.50)] backdrop-blur-[.4rem] rounded-[0px_0px_1.875rem_1.875rem] flex items-center pl-8'>
